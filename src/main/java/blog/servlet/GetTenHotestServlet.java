 ...
 */
@WebServlet("/GetTenHotestServlet")
public class GetTenHotestServlet extends AutowiredHttpServlet{
    @Autowired
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        List<Article> articleList = (ArrayList<Article>)articleService.getTenHotest();
